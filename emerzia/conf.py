...
# in a prominent link
SITE_URL = "http://www.emerzia.com/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nikola.ralsina.com.ar"
BLOG_EMAIL = "hello@emerzia.com"
BLOG_DESCRIPTION = "Emerzia is a reverse emergency notification system to broadcast messages via Voice and SMS"
...
# Default is ''
CONTENT_FOOTER = 'Copyright &copy; {date} {author}. All Rights Reserved.'
CONTENT_FOOTER = CONTENT_FOOTER.format(email=BLOG_EMAIL,
                                       author='Star2Billing S.L.',
...
<script>
  ...
  ga('create', 'UA-325034-19', 'emerzia.com');
  ga('send', 'pageview');
</script>

<!-- AddThis Smart Layers BEGIN -->
<!-- Go to http://www.addthis.com/get/smart-layers to customize -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4f2996314fcd3dfc"></script>
<script type="text/javascript">
  addthis.layers({
    ...
    'follow' : {
      'services' : [
        {'service': 'facebook', 'id': 'emerzia'},
        {'service': 'twitter', 'id': 'emerzia'}
      ]
    }
  });
</script>
